...
const gameStatsSchema = new mongoose.Schema(
  {
    ...
    totalCoins:  { type: Number, default: 100 },  // coins gagnés depuis toujours
    totalPoints: { type: Number, default: 0 },    // points classement (jamais dépensés)
    ...
    cards:            { type: Array,  default: [] },   // collection de cartes
  },
  { timestamps: true }
);
// ── Challenge ─────────────────────────────────────────────────────────────
const challengeSchema = new mongoose.Schema(
  {
    ...
    challenger:   { type: String, required: true }, // username
    challengerTeam: { type: Array, required: true }, // joueurs
    challengerRating: { type: Number, default: 0 },
    opponent:     { type: String, default: null },  // username adversaire
    result:       { type: Object, default: null },  // résultat du match
    status:       { type: String, default: "pending" }, // pending | completed
  },
  { timestamps: true, expireAfterSeconds: 60 * 60 * 24 * 7 } // expire après 7 jours
);
